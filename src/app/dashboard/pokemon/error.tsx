    ...
    return (
        <div className="w-full h-screen flex flex-col items-center justify-center">
            ...
            >
                ...
                <polygon points="968.978 667.466 968.978 673.526 642.968 673.526 642.968 668.678 643.417 667.466 651.452 645.651 962.312 645.651 968.978 667.466" fill="#2f2e41"></polygon><path d="M1125.828,762.03359c-.59383,2.539-2.83591,5.21743-7.90178,7.75032-18.179,9.08949-55.1429-2.42386-55.1429-2.42386s-28.4804-4.84773-28.4804-17.573a22.72457,22.72457,0,0,1,2.49658-1.48459c7.64294-4.04351,32.98449-14.02122,77.9177.42248a18.73921,18.73921,0,0,1,8.54106,5.59715C1125.07908,756.45353,1126.50669,759.15715,1125.828,762.03359Z" transform="translate(-31.39089 -100.5)" fill="#2f2e41"></path>
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <p className="md:text-lg xl:text-xl text-gray-500 mt-4">Ocurrio algo terrible hermano, llamen a dios</p>
            </div>
        </div>
        // <div>
        //   <h2>Algo hizo cambum</h2>
