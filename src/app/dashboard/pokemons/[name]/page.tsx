...
import { IPokemon, IPokemonsResponse } from "@/pokemons";
...
export async function generateStaticParams() {
  const data: IPokemonsResponse = await fetch(`https://pokeapi.co/api/v2/pokemon?limit=${151}&offset=${0}`, { cache: 'force-cache' })
